...
// Phase 1A — exactly-once transaction mutations at UI and context layers.
replaceOnce('src/components/AddTransactionModal.tsx',
...
replaceBetween('src/utils/emi.ts', 'export function calculateEmiSplit(', '/**\n * Calculates monthly or periodic EMI/interest amount', `export function calculateEmiSplit(
  balance: number,
  annualRate: number,
  emi: number,
