...
export function WalletSummaryModal() {
  ...
  // Classify accounts
  const cashAccounts = accounts.filter(a => a.type === 'asset' && (a.id === 'cash' || a.name.toLowerCase().includes('cash') || a.group?.toLowerCase().includes('cash')));
  const bankAccounts = accounts.filter(a => a.type === 'asset' && !(a.id === 'cash' || a.name.toLowerCase().includes('cash') || a.group?.toLowerCase().includes('cash')));
