    ...
    <div className="space-y-6">
      ...
      <section className="rounded-3xl border border-outline-variant/30 bg-surface-container p-5 sm:p-6">
        ...
        <div className="mt-5 grid gap-4 sm:grid-cols-2">
          ...
          <label className="block"><span className="text-xs font-bold uppercase tracking-wide text-on-surface-variant">Household total</span><div className="mt-1.5"><CurrencyInput value={totalAmount} onChange={setTotalAmount} /></div></label>
        </div>
